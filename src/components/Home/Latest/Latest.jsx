    ...
    <div className="py-16 bg-[#fcfdfe] dark:bg-slate-900/50 transition-colors duration-300">
      <Container>
        <div className="flex flex-col items-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-black text-slate-900 dark:text-white text-center mb-4">
            Latest & <span className="text-emerald-600 italic">Popular</span>{" "}
            Books
          </h2>

          <p className="text-slate-500 dark:text-slate-400 text-center max-w-xl text-sm md:text-base leading-relaxed">
        ...
        <div className="mt-16 text-center">
          <Link
            to={"/all-books"}
            className="border-2 border-slate-900 dark:border-emerald-500 text-slate-900 dark:text-emerald-500 px-8 py-3 rounded-full font-bold hover:bg-slate-900 dark:hover:bg-emerald-500 hover:text-white dark:hover:text-slate-900 transition-all duration-300 inline-block"
          >
